...
import com.arcgishelper.lib_arcgis.entity.MapLayerType;
import com.arcgishelper.lib_arcgis.entity.MapServiceProvider;
...
public class TileFactory {
    ...
    public static MapLayerInfo createLayerInfo(MapServiceProvider serviceProvider, MapLayerType layerType) {
        ...
        switch (serviceProvider) {
            ...
            case BAIDU:
                switch (layerType) {
                    case VECTOR:
                        layerInfo.setLayerName(BAIDU.VECTOR_NAME);
                    ...
                    case IMAGE:
                        ...
                        break;
                    case ROAD:
                        layerInfo.setLayerName(BAIDU.ROAD_NAME);
                        layerInfo.setMinZoomLevel(3);
                        layerInfo.setMaxZoomLevel(19);
                        break;
                    case TRAFFIC:
            ...
            case TENCENT:
                switch (layerType) {
                    case VECTOR:
                        layerInfo.setLayerName(TENCENT.VECTOR_NAME);
                        break;
                    case IMAGE:
                        layerInfo.setLayerName(TENCENT.IMAGE_NAME);
                        break;
                    case ROAD:
                        layerInfo.setLayerName(TENCENT.ROAD_NAME);
                    case TRAFFIC:
                        layerInfo.setLayerName(TENCENT.TERRAIN_NAME);
                        break;
                }
                break;
            case GOOGLE:
                switch (layerType) {
                    case VECTOR:
                        layerInfo.setLayerName(GOOGLE.VECTOR_NAME);
                        layerInfo.setMaxZoomLevel(21);
                        break;
                    case IMAGE:
                        layerInfo.setLayerName(GOOGLE.IMAGE_IMAGE);
                        layerInfo.setMaxZoomLevel(21);
                        break;
                    case TRAFFIC:
                        layerInfo.setLayerName(GOOGLE.TERRAIN_NAME);
                        layerInfo.setMaxZoomLevel(21);
                        break;
                }
                break;
